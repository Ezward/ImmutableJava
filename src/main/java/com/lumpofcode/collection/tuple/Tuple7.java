...
public final class Tuple7<T1, T2, T3, T4, T5, T6, T7>
{
	...
	{
		return new Tuple7(mapper1.apply(t1), mapper2.apply(t2), mapper3.apply(t3), mapper4.apply(t4), mapper5.apply(t5), mapper6.apply(t6), mapper7.apply(t7));
	}
	...
	public boolean equals(Object that)
	{
		...
		if (t1 != null ? !t1.equals(tuple7.t1) : tuple7.t1 != null) return false;
		if (t2 != null ? !t2.equals(tuple7.t2) : tuple7.t2 != null) return false;
		if (t3 != null ? !t3.equals(tuple7.t3) : tuple7.t3 != null) return false;
		if (t4 != null ? !t4.equals(tuple7.t4) : tuple7.t4 != null) return false;
		if (t5 != null ? !t5.equals(tuple7.t5) : tuple7.t5 != null) return false;
		if (t6 != null ? !t6.equals(tuple7.t6) : tuple7.t6 != null) return false;
