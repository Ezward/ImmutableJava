...
public final class Tuple6<T1, T2, T3, T4, T5, T6>
{
	 ...
	 */
	public <R1> Tuple6<R1, T2, T3, T4, T5, T6> map_1 (@NotNullable Function <? super T1, ? extends R1> mapper1)
	{
	 ...
	 */
	public <R2> Tuple6<T1, R2, T3, T4, T5, T6> map_2 (@NotNullable Function <? super T2, ? extends R2> mapper2)
	{
	 ...
	 */
	public <R3> Tuple6<T1, T2, R3, T4, T5, T6> map_3 (@NotNullable Function <? super T3, ? extends R3> mapper3)
	{
	 ...
	 */
	public <R4> Tuple6<T1, T2, T3, R4, T5, T6> map_4 (@NotNullable Function <? super T4, ? extends R4> mapper4)
	{
	 ...
	 */
	public <R5> Tuple6<T1, T2, T3, T4, R5, T6> map_5 (@NotNullable Function <? super T5, ? extends R5> mapper5)
	{
	 ...
	 */
	public <R6> Tuple6<T1, T2, T3, T4, T5, R6> map_6 (@NotNullable Function <? super T6, ? extends R6> mapper6)
	{
