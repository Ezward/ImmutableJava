...
public final class Tuple5<T1, T2, T3, T4, T5>
{
	 ...
	 */
	public <R> R map(@NotNull Function<? super Tuple5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5>, ? extends R> mapper)
	{
	 ...
	 */
	public <R1> Tuple5<R1, T2, T3, T4, T5> map_1 (@NotNull Function <? super T1, ? extends R1> mapper1)
	{
	 ...
	 */
	public <R2> Tuple5<T1, R2, T3, T4, T5> map_2 (@NotNull Function <? super T2, ? extends R2> mapper2)
	{
	 ...
	 */
	public <R3> Tuple5<T1, T2, R3, T4, T5> map_3 (@NotNull Function <? super T3, ? extends R3> mapper3)
	{
	 ...
	 */
	public <R4> Tuple5<T1, T2, T3, R4, T5> map_4 (@NotNull Function <? super T4, ? extends R4> mapper4)
	{
	 ...
	 */
	public <R5> Tuple5<T1, T2, T3, T4, R5> map_5 (@NotNull Function <? super T5, ? extends R5> mapper5)
	{
