...
public final class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>
{
	...
	{
		return new Tuple8(mapper1.apply(this._1), mapper2.apply(this._2), mapper3.apply(this._3), mapper4.apply(this._4), mapper5.apply(this._5), mapper6.apply(this._6), mapper7.apply(this._7), mapper8.apply(this._8));
	}
	...
	public String toString()
	{
		...
		sb.append(", this._8: ").append((null != this._8) ? this._8 : "null");
		sb.append('}');
	...
	public boolean equals(Object that)
	{
		...
		if (this._1 != null ? !this._1.equals(tuple8._1) : tuple8._1 != null) return false;
		if (this._2 != null ? !this._2.equals(tuple8._2) : tuple8._2 != null) return false;
		if (this._3 != null ? !this._3.equals(tuple8._3) : tuple8._3 != null) return false;
		if (this._4 != null ? !this._4.equals(tuple8._4) : tuple8._4 != null) return false;
		if (this._5 != null ? !this._5.equals(tuple8._5) : tuple8._5 != null) return false;
		if (this._6 != null ? !this._6.equals(tuple8._6) : tuple8._6 != null) return false;
		if (this._7 != null ? !this._7.equals(tuple8._7) : tuple8._7 != null) return false;
		if (this._8 != null ? !this._8.equals(tuple8._8) : tuple8._8 != null) return false;
	...
	public int hashCode()
	{
		...
		result = 31 * result + (this._8 != null ? this._8.hashCode() : 0);
		return result;
	}
