...
public final class VectorOf7<T> implements Vector<T>, Iterable<T>
{
	...
	public VectorOf7(final T element0, final T element1, final T element2, final T element3, final T element4, final T element5, final T element6)
	{
	...
	public Vector<T> set(final int index, final T value)
	{
		switch(index)
		{
			case 0: return new VectorOf7<>(value, element1, element2, element3, element4, element5, element6);
			case 1: return new VectorOf7<>(element0, value, element2, element3, element4, element5, element6);
			case 2: return new VectorOf7<>(element0, element1, value, element3, element4, element5, element6);
			case 3: return new VectorOf7<>(element0, element1, element2, value, element4, element5, element6);
			case 4: return new VectorOf7<>(element0, element1, element2, element3, value, element5, element6);
			case 5: return new VectorOf7<>(element0, element1, element2, element3, element4, value, element6);
			case 6: return new VectorOf7<>(element0, element1, element2, element3, element4, element5, value);
			case 7: return append(value);
		}
	...
	{
		return new VectorOf8<>(element0, element1, element2, element3, element4, element5, element6, value);
	}
	...
	{
		return new VectorTrie<T>(1, new VectorOf16(element0, element1, element2, element3, element4, element5, element6, e0, e1, e2, e3, e4, e5, e6, e7, e8), new VectorOf7(e9, e10, e11, e12, e13, e14, e15));
	}
	...
	{
		return new VectorOf7<>(mapper.apply(element0), mapper.apply(element1), mapper.apply(element2), mapper.apply(element3), mapper.apply(element4), mapper.apply(element5), mapper.apply(element6));
	}
