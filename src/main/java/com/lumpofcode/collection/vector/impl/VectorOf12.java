...
public final class VectorOf12<T> implements Vector<T>, Iterable<T>
{
	...
	public VectorOf12(T element0, T element1, T element2, T element3, T element4, T element5, T element6, T element7, T element8, T element9, T element10, T element11)
	{
	...
	{
		return "[" + element0.toString() + ", " + element1.toString() + ", " + element2.toString() + ", " + element3.toString() + ", " + element4.toString() + ", " + element5.toString() + ", " + element6.toString() + ", " + element7.toString() + ", " + element8.toString() + ", " + element9.toString() + ", " + element10.toString() + ", " + element11.toString() + "]";
