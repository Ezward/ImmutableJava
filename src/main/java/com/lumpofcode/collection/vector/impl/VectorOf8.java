...
public final class VectorOf8<T> implements Vector<T>, Iterable<T>
{
	...
	public VectorOf8(T element0, T element1, T element2, T element3, T element4, T element5, T element6, T element7)
	{
	...
	{
		return "[" + element0.toString() + ", " + element1.toString() + ", " + element2.toString() + ", " + element3.toString() + ", " + element4.toString() + ", " + element5.toString() + ", " + element6.toString() + ", " + element7.toString() + "]";
